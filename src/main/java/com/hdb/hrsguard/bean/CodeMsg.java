...
public class CodeMsg {
    ...
    //病人病历修改类错误
    public static CodeMsg ADMIN_PATIENT_NAME_ERROR =new CodeMsg(-6555,"病人名字错误");
    public static CodeMsg ADMIN_PATIENT_UPDATE_ERROR =new CodeMsg(-6556,"病人病历更新错误");
    public static CodeMsg ADMIN_PATIENT_AGE_ERROR=new CodeMsg(-6557,"病人年龄应在0到110之间");

    //病人挑选的医院部门
    public static CodeMsg ADMIN_PATIENT_SELECT_DEPID_ERROR=new CodeMsg(6559,"病人的挑选的部门id为空");
    public static CodeMsg ADMIN_PATIENT_MATCH_DEP_ERROR =new CodeMsg(6560,"病人科室匹配有误");
    //文件错误
    public static CodeMsg ADMIN_FILE_FORMAT_ERROR=new CodeMsg(4555,"文件格式传输错误，推荐用txt文件");
    //关键词传输为空
    public static CodeMsg ADMIN_WORD_ERROR=new CodeMsg(3256,"你的关键词传输为空");
    public static CodeMsg ADMIN_SELECT_DOC_ERROR=new CodeMsg(3257,"您不能多选医生或者不选");
    public static CodeMsg ADMIN_SELECT_DOC_EMPTY=new CodeMsg(3258,"您的医生为空");
