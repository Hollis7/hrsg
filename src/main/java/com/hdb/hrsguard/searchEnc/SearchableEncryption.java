package com.hdb.hrsguard.searchEnc;
...
//            System.out.println("iv: "+iv.getBytes());
    ...
    public static void encryptFile(String rawPath,String encPath) throws IOException {
        FileUtil.deleteFiles(encPath);
        File[] files = FileUtil.getDirFiles(rawPath);
        for (File file : files)  {
...
//                System.out.println("FiSi: "+FiSi);
                ...
                String writePath = encPath+fileName;
    ...
    public static String searchFile(String keyword,String encPath) throws IOException {
        boolean flag;
        String allfilename="#";
        File[] files = FileUtil.getDirFiles(encPath);
        String str = keyword;
...
//        encryptFile(FilePathConstant.SEARCH_RAW_PATH,FilePathConstant.SEARCH_ENC_PATH);

        while(true) {
            System.out.print("input keyword to search: ");
            Scanner sc = new Scanner(System.in);
            String str = sc.nextLine();
            String result=searchFile(str,FilePathConstant.SEARCH_ENC_PATH);
