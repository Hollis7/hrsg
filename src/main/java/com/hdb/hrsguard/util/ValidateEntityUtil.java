...
public class ValidateEntityUtil {
    ...
    public static CodeMsg validate(Object object){
        Field[] declaredFields = object.getClass().getDeclaredFields();//拿到所有字段如user的name、passwd
        for(Field field : declaredFields){
            ValidateEntity annotation = field.getAnnotation(ValidateEntity.class);//拿到字段注解
            if(annotation != null){
