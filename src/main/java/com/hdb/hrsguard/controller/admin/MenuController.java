...
import com.hdb.hrsguard.service.admin.MenuService;
import com.hdb.hrsguard.service.admin.OperaterLogService;
import com.hdb.hrsguard.util.MenuUtil;
...
public class MenuController {
    ...
    public String list(Model model){
        List<Menu> menuServiceAll = menuService.findAll();
        model.addAttribute("title","菜单列表");
        model.addAttribute("topMenus", MenuUtil.getTopMenus(menuServiceAll));
        model.addAttribute("secondMenus",MenuUtil.getSecondMenus(menuServiceAll));
    ...
    public Result<Boolean> add(HttpServletRequest request, Menu menu){
        ...
        operaterLogService.add(user.getUsername(),"添加菜单信息【" + menu + "】");
